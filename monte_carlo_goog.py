...
apple = yf.download('GOOG', start='2009-01-01')
...
plt.legend()
plt.grid(True)
plt.savefig('histogram_google.png')
plt.show()
...
data_to_pickle = {
    ...
    'mean_end_price2': mean_end_price,
    'top_ten_percentile2': top_ten,
    'bottom_ten_percentile2': bottom_ten,
    'graph': plt.hist(closing_prices, bins=40, edgecolor='black')
}

pickle_file_path = 'stock_simulation_data_google.pkl'
